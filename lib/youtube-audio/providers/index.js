...
import { YoutubeAudioProviderError } from "./rapidapi-client";
import { youtubeMp32025Provider } from "./youtube-mp3-2025";
import { youtubeMp36Provider } from "./youtube-mp36";

const providers = new Map(
  [youtubeMp36Provider, youtubeMp32025Provider].map((provider) => [
    provider.id,
    provider,
  ]),
);
