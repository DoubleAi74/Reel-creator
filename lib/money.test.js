...
describe("money helpers", () => {
  ...
  it("validates custom top-ups as integer pence from \u00a31 to \u00a3100", () => {
    expect(TOP_UP_MIN_MINOR).toBe(100);
    expect(TOP_UP_MAX_MINOR).toBe(10000);
    expect(isValidTopUpMinor(0)).toBe(false);
    expect(isValidTopUpMinor(1)).toBe(false);
    expect(isValidTopUpMinor(50)).toBe(false);
    expect(isValidTopUpMinor(99)).toBe(false);
    expect(isValidTopUpMinor(100)).toBe(true);
