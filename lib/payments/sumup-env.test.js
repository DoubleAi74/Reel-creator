...
describe("SumUp environment validation", () => {
  ...
  it("accepts sandbox/server secret key formats", () => {
  ...
  it("rejects public, affiliate, and wrong-mode key shapes", () => {
  ...
  it("rejects temporary live URLs unless explicitly allowed", () => {
  ...
  it("selects split test/live credentials by mode", () => {
    resetSumUpEnvironmentForTests();
