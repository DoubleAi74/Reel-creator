import { getTextLayerFormat, normalizeTextLayerMode } from "./formats";
...
// Sessions backing a queued or running render, so the file sweeper can exempt
// their assets even when the browser has stopped polling.
export function getActiveRenderSessionIds() {
