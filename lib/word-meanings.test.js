...
describe("applyWordMeaningsToLines", () => {
  ...
  it("preserves timing when Part 3 runs before Part 2", () => {
    const result = applyWordMeaningsToLines(
      [
        {
          id: "timed",
          original: "आज से",
  ...
  it("preserves gloss when Part 2 runs before Part 3", () => {
    const result = mergeMeaningWordsWithTiming(
      [
        { end: 1.4, start: 1, text: "आज" },
        { end: 1.8, start: 1.4, text: "से" },
      ],
