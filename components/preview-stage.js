...
export function PreviewStage({
  ...
  // Fullscreen "clean recording" mode: the close button is hidden by default so
  // a phone screen recording of the preview rectangle starts clean and isn't
  // interrupted by chrome. Tapping the stage reveals it, and it auto-hides again
  // after a short idle. See CLIENT_BROWSER_EXPORT / preview UX notes.
  ...
  // Every fullscreen session starts with the close button hidden; clear any
  // pending idle timer on enter/exit.
  useEffect(() => {
    if (hideTimerRef.current) {
      clearTimeout(hideTimerRef.current);
