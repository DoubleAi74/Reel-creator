...
export function PreviewStage({
  ...
  return (
    <>
          ...
          <div
            className={`preview-screen relative overflow-hidden bg-(--preview-bg) ${
              isPreviewFullscreen
                ...
                : "mx-auto aspect-[9/16] h-[62dvh] w-auto max-w-full rounded-[1.5rem] lg:aspect-[9/16] lg:h-full lg:max-h-full lg:w-auto lg:max-w-full lg:rounded-[2rem] lg:border lg:border-white/12 lg:shadow-[0_30px_70px_rgba(0,0,0,0.5)]"
            }`}
          >
      ...
      {!isPreviewFullscreen ? (
        <section className="wb-slot flex min-h-[62dvh] flex-none flex-col items-center justify-center overflow-hidden p-2 lg:order-2 lg:min-h-0 lg:flex-1 lg:items-center lg:justify-center lg:rounded-2xl lg:p-2">
          <WordBoard
            lines={project.lines}
            selectedWordId={selectedWordId}
            onSelectWord={handleSelectWord}
