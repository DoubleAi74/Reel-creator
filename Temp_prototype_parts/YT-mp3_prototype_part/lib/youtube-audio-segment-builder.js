...
import { fetchMediaToFile } from "./audio-media-fetcher.js";
import { logDiagnostic } from "./diagnostics.js";
import { getYoutubeAudioConfig } from "./server-config.js";
import { storeFinalMp3 } from "./youtube-audio-storage.js";
...
export async function buildYoutubeAudioSegment(job, providerResult, options = {}) {
  ...
  try {
    ...
    const mediaResult = await fetchMediaToFile(providerResult, {
